...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/factions/{factionSymbol}".format(client.base_url, factionSymbol=faction_symbol)
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[GetFactionResponse200]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[GetFactionResponse200]:
    return Response(
