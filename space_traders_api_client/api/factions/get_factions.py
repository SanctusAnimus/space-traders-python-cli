...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[GetFactionsResponse200]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[GetFactionsResponse200]:
    return Response(
