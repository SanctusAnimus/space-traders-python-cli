...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[GetWaypointResponse200]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[GetWaypointResponse200]:
    return Response(
