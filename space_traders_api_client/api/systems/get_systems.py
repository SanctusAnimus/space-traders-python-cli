...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[GetSystemsResponse200]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[GetSystemsResponse200]:
    return Response(
