...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[GetMyShipResponse200]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[GetMyShipResponse200]:
    return Response(
