...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[GetContractsResponse200]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[GetContractsResponse200]:
    return Response(
